  ...
  return (
    <section className={`relative min-h-screen flex items-center overflow-hidden hero-gradient cross-pattern
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="float-anim absolute top-20 right-20 opacity-10">
          <img src={dark ? "/logowhite.png" : "/logo.png"} alt="" className="w-64 h-64 object-contain" />
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-24 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center mb-8">
            <div className="relative float-anim-2">
              <img
                ...
                alt="The Call Global"
                className="h-28 w-28 object-contain rounded-full shadow-none"
              />
              <div className="absolute inset-0 rounded-full ring-1 ring-blue-300/20 ring-offset-4"></div>
            </div>
          </div>
          ...
          <h1 className={`font-display text-5xl md:text-7xl font-bold leading-tight mb-6
            ...
            You Were Made
            <span className="block brand-text-black mt-1">
              For More Than This
            </span>
          </h1>
